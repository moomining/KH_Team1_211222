...
public class Pikachu extends PokemonDTO {
	...
	public void recharge() {
		...
		if(this.HP < 100) {
			System.out.println("[system] : 피카츄의 HP가 100% 충전되었습니다.");
			this.HP = 100;
		} else {
	...
	public void attack() {
		// TODO Auto-generated method stub
		if (HP >= 50) { 
			System.out.println("[system] : 피카츄(이)가 전기를 쏩니다. 치지직===ZZ"");
			HP -= 30;
			count++;
			...
			if (mission == count) {
				...
				System.out.print("[system] : 진화 미션 회수를 모두 채우셨습니다. 진화를 진행하시겠습니까? (y/n) : ");
